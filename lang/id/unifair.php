...
$string['requiredchoices'] = 'Jumlah pilihan wajib per siswa';
$string['requiredchoices_help'] = 'Isi 0 untuk mengikuti perilaku lama: siswa memilih tepat satu universitas pada setiap sesi. Isi angka seperti 4 untuk mengunci setiap siswa agar hanya dapat menyimpan tepat 4 pilihan total, dengan tetap maksimal satu universitas per sesi.';
$string['requiredchoicesnonnegative'] = 'Jumlah pilihan wajib tidak boleh negatif.';
$string['requiredchoicesexceedssessions'] = 'Jumlah pilihan wajib tidak boleh melebihi jumlah sesi yang tersedia ({$a}).';
$string['requiredchoicesbelowexisting'] = 'Tidak dapat menurunkan batas ini karena sudah ada siswa dengan {$a} pilihan. Koreksi pilihan siswa terlebih dahulu.';
...
$string['pickrequiredtotal'] = 'Pilih tepat {$a} universitas. Maksimal satu universitas per sesi.';
$string['choiceprogress'] = 'Progress pilihan: {$a->current}/{$a->required}.';
$string['choicetargetreached'] = 'Target {$a} pilihan sudah terpenuhi. Sesi lain dikunci untuk siswa.';
...
$string['error_choicelimit'] = 'Anda hanya boleh menyimpan {$a} pilihan universitas pada aktivitas ini.';
$string['error_exactchoices'] = 'Simpan tepat {$a} pilihan universitas.';
...
$string['teacherrequiredchoicesnotice'] = 'Mode target aktif: siswa harus memiliki tepat {$a} pilihan total. Gunakan "Tidak ada pilihan pada sesi ini" untuk sesi yang tidak dipakai.';
$string['noselectionforsession'] = 'Tidak ada pilihan pada sesi ini';
...
$string['incompletestudentlisttarget'] = 'Siswa yang belum mencapai target {$a} pilihan';
